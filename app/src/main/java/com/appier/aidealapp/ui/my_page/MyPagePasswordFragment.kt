...
import kotlinx.android.synthetic.main.fragment_my_page_password.*

class MyPagePasswordFragment : Fragment() {
    private val aiDeal = AiDeal.getInstance()

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_my_page_password, container, false)
    }
